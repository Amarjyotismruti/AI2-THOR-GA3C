...
def create_p_and_v_models(model_name, num_actions, img_height, img_width, img_channels):
	...
	elif 'thor' in model_name:
		return create_thor_models(num_actions, img_height, img_width, img_channels)
	else:
		raise('Model does not exist.')

def create_thor_models(num_actions, img_height, img_width, img_channels):
