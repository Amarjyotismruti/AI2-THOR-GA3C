...
class HistoryPreprocessor(Preprocessor):
    ...
    def __init__(self, state_shape, history_length=1):
        self.state_shape = state_shape
        self.history_length = history_length
        self.history = np.zeros(state_shape+(history_length,))
    ...
    def reset(self):
        ...
        """
        self.history = np.zeros(self.state_shape+(self.history_length,))
