...
class Observation:
    ...
    def __eq__(self, sample):
      return (self.state       == sample.state).all() \
         and  self.action      == sample.action \
         and  self.reward      == sample.reward \
         and  self.is_terminal == sample.is_terminal
...
class Sample:
    ...
    def __eq__(self, sample):
      return (self.state       == sample.state).all() \
         and  self.action      == sample.action \
         and  self.reward      == sample.reward \
         and (self.next_state  == sample.next_state).all() \
         and  self.is_terminal == sample.is_terminal
